...
/datum/preferences
	...
	var/be_cultleader = FALSE
	var/be_cultmember = FALSE
	...
	ui_data(mob/user)
		...
		. = list(
			...
			"antagonistPreferences" = list(
				...
				ROLE_CULT_LEADER = src.be_cultleader,
				ROLE_CULT_MEMBER = src.be_cultmember,
	...
	ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
		...
		switch (action)
			...
			if ("reset")
				...
				src.be_cultleader = FALSE
				src.be_cultmember = FALSE
...
#define CHAR_EXPORT_SECRET "input_validation_is_hell_sorry"
	...
	proc/GetJobStaticData(mob/user)
		...
		var/list/team_antagonists = list(
			...
			ROLE_CULT_LEADER = TRUE,
			ROLE_CULT_MEMBER = TRUE,
